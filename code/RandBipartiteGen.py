...
if __name__ == "__main__":
    ...
    for i in range(args.size):
        ...
        sorted_nodes = sorted(range(len(degrees.values())), key=lambda c: degrees.values()[c], reverse=True)
    ...
    with open("datasets/RB" + str(args.size) + args.type + "_" + str(n) + "_" + str(m) + "_" + str(k), "w") as f:
